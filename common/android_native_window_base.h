...
protected:
	...
	void setHybrisWindow(HybrisBaseWindow *window)
	{
		m_hybrisWindow = window;
	}

	HybrisBaseWindow* getHybrisWindow(void)
	{
		return m_hybrisWindow;
	}

private:
	HybrisBaseWindow *m_hybrisWindow;
